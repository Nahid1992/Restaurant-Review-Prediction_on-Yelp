...
def kappa(test,pred,algo_name):
    path_name = "Results/08_Dataset_Run_16ATR_5CLASS.txt"
...
def showAttributes(xTicks,selectedSum,selectedList):
    ...
    plt.tight_layout()
    path_name = "Results/08_Dataset_Run_16ATR_5CLASS "
...
if __name__ == '__main__':
    ...
    print "08_Dataset_Run_16ATR_5CLASS => New Set + Mean Cut"
...
#    Ridge_Mode(X_train,y_train,X_test,y_test,num_class)
    ...
    result_DF.to_csv('Results/08_Table_Result_16ATR_5CLASS.csv')