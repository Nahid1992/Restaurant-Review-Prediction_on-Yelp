...
def kappa(test,pred,algo_name):
    path_name = "Results/11_Dataset_Run_48ATR_3CLASS.txt"
...
def showAttributes(xTicks,selectedSum,selectedList):
    ...
    plt.tight_layout()
    path_name = "Results/11_Dataset_Run_48ATR_3CLASS"
...
if __name__ == '__main__':
    ...
    print "11_Dataset_Run_48ATR_3CLASS => Old Set + No Cut"
...
#    Ridge_Mode(X_train,y_train,X_test,y_test,num_class)
    ...
    result_DF.to_csv('Results/11_Table_Result_48ATR_3CLASS.csv')