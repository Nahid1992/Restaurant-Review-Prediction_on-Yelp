...
def kappa(test,pred,algo_name):
    path_name = "Results/02_Dataset_Run_16ATR_2CLASS.txt"
...
def showAttributes(xTicks,selectedSum,selectedList):
    ...
    plt.tight_layout()
    path_name = "Results/02_Dataset_Run_16ATR_2CLASS"
...
if __name__ == '__main__':
    ...
    print "02_Dataset_Run_16ATR_2CLASS => New Set + Mean Cut"
...
#    Ridge_Mode(X_train,y_train,X_test,y_test,num_class)
    ...
    result_DF.to_csv('Results/02_Table_Result_16ATR_2CLASS.csv')