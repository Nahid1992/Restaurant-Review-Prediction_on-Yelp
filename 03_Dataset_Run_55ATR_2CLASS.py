...
def kappa(test,pred,algo_name):
    path_name = "Results/03_Dataset_Run_55ATR_2CLASS.txt"
...
def showAttributes(xTicks,selectedSum,selectedList):
    ...
    plt.tight_layout()
    path_name = "Results/03_Dataset_Run_55ATR_2CLASS"
...
if __name__ == '__main__':
    ...
    print "03_Dataset_Run_55ATR_2CLASS => New Set + No Cut"
...
#    Ridge_Mode(X_train,y_train,X_test,y_test,num_class)
    ...
    result_DF.to_csv('Results/03_Table_Result_55ATR_2CLASS.csv')