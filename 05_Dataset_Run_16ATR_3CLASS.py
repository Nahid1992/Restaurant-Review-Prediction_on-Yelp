...
def kappa(test,pred,algo_name):
    path_name = "Results/05_Dataset_Run_16ATR_3CLASS.txt"
...
def showAttributes(xTicks,selectedSum,selectedList):
    ...
    plt.tight_layout()
    path_name = "Results/05_Dataset_Run_16ATR_3CLASS"
...
if __name__ == '__main__':
    ...
    print "05_Dataset_Run_16ATR_3CLASS => New Set + Mean Cut"
...
#    Ridge_Mode(X_train,y_train,X_test,y_test,num_class)
    ...
    result_DF.to_csv('Results/05_Table_Result_16ATR_3CLASS.csv')